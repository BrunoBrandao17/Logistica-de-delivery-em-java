...
import com.example.delivery.model.FuncionarioModel;
import com.example.delivery.service.FuncionarioService;
...
public class FuncionarioController {
    ...
    public ResponseEntity<Map<String, Object>> excluir(@PathVariable Long id) {
        ...
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(Map.of("Mensagem", "Funcionário exlucuido com sucesso"));
    }
}
